...
public class PrinterService {
	...
	public void printTags(String printerCode, String barcodePosition, List<Tag> tags, ContextValidation ctxVal){
		...
		if(null != bbp11){
			...
			ctxVal.addErrors("printer", ValidationConstants.ERROR_NOTEXISTS_MSG, printerCode);
		}		
	}
	...
	private void printTags(BBP11 bbp11, BarcodePosition position,
			List<Tag> tags, ContextValidation ctxVal) {
