...
import models.description.common.dao.PropertyDefinitionDAO;
import models.description.common.dao.ResolutionDAO;
...
import models.description.experiment.dao.InstrumentCategoryDAO;
import models.description.experiment.dao.InstrumentDAO;
import models.description.experiment.dao.InstrumentUsedTypeDAO;
import models.description.experiment.dao.ProtocolDAO;
import models.description.experiment.dao.ReagentTypeDAO;
import models.description.project.ProjectType;
import models.description.project.dao.ProjectTypeDAO;
...
public class SpringTest {
	...
	public void start(){
		...
		Helpers.start(app);
		//Test if data exist
		//Experiment Type with commonInfoType id=3
		ExperimentTypeDAO expTypeDAO = Spring.getBeanOfType(ExperimentTypeDAO.class);
		ExperimentType expType = expTypeDAO.findByCommonInfoType(idCommonInfoType);
		if(expType==null)
			throw new RuntimeException("Error data experiment type with commonInfoType id="+idCommonInfoType+" has been deleted");
	}
	@After
	public void stop(){
		Helpers.stop(app);
	...
	private void checkCommonInfo(CommonInfoType cit)
	{
		...
		Assert.assertNotNull(cit.getId());
	...
	public void testNextExperimentTypes()
	{
		...
		for(ExperimentType expType : nextExpTypes){
			...
			Assert.assertNotNull(expType.getCommonInfoType().getId());
		}
	}
