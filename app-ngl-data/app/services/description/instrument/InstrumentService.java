...
public class InstrumentService {
	...
	private static List<PropertyDefinition> getNanoporeProperties() throws DAOException {
        ...
        propertyDefinitions.add(newPropertiesDefinition("QC avant d�marrage run", "qcBeforeRun", LevelService.getLevels(Level.CODE.Instrument),Double.class, true, "single",500));
