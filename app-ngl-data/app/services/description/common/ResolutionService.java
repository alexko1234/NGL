...
public class ResolutionService {
	...
	public static void saveResolutionCategories(Map<String,List<ValidationError>> errors) throws DAOException{
		...
		//Run
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me machine", "PbM", (short) 20));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me rÃ©actifs", "PbR", (short) 30)); 
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me qualitÃ© : SAV", "SAV", (short) 40));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me librairie", "RUN-LIB", (short) 50));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me informatique", "PbI", (short) 60));
		...
		//ReadSet
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me run", "Run", (short) 5));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me librairie", "LIB", (short) 10));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me quantitÃ©", "Qte", (short) 15));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me indexing", "IND", (short) 20));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me qualitÃ©", "Qlte", (short) 25));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me taxon", "TAXO", (short) 30));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me ribosomes", "RIBO", (short) 35));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me mapping", "MAP", (short) 40));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me merging", "MERG", (short) 45));	
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me Ã©chantillon", "Sample", (short) 55));
		l.add(DescriptionFactory.newResolutionCategory("ProblÃ¨me dÃ©claration LIMS", "LIMS", (short) 60));
	...
	public static void saveResolutions(Map<String,List<ValidationError>> errors) throws DAOException{
		...
		//Run
		l.add(newResolution("indÃ©terminÃ©","PbM-indetermine",ResolutionCategory.find.findByCode("PbM"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 1));
		...
		l.add(newResolution("zone de dÃ©pÃ´t","PbM-zoneDepot",ResolutionCategory.find.findByCode("PbM"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 10));				
		...
		l.add(newResolution("indÃ©terminÃ©","PbR-indetermine",ResolutionCategory.find.findByCode("PbR"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 1));
		...
		l.add(newResolution("sÃ©quencage","PbR-sequencage",ResolutionCategory.find.findByCode("PbR"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 4));
		...
		l.add(newResolution("erreur rÃ©actifs","PbR-erreurReac",ResolutionCategory.find.findByCode("PbR"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 10));
		l.add(newResolution("rajout rÃ©actifs","PbR-ajoutReac",ResolutionCategory.find.findByCode("PbR"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 11));
		
		l.add(newResolution("intensitÃ©","SAV-intensite",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 1));
		
		l.add(newResolution("intensitÃ© faible A","SAV-intFbleA",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 2));
		l.add(newResolution("intensitÃ© faible T","SAV-intFbleT",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 3));
		l.add(newResolution("intensitÃ© faible C","SAV-intFbleC",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 4));
		l.add(newResolution("intensitÃ© faible G","SAV-intFbleG",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 5));
		
		l.add(newResolution("densitÃ© clusters trop Ã©levÃ©e","SAV-densiteElevee",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 6));
		l.add(newResolution("densitÃ© clusters trop faible","SAV-densiteFaible",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 7));
		l.add(newResolution("densitÃ© clusters nulle","SAV-densiteNulle",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 8));
		...
		l.add(newResolution("% bases dÃ©sÃ©quilibrÃ©","SAV-perctBasesDeseq",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 15));
		l.add(newResolution("index non reprÃ©sentÃ©","SAV-indexNonPresent",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 16));
		l.add(newResolution("index sous-reprÃ©sentÃ©","SAV-indexFblePerc",ResolutionCategory.find.findByCode("SAV"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 17));
		...
		l.add(newResolution("indÃ©terminÃ©","PbI-indetermine",ResolutionCategory.find.findByCode("PbI"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 1));
		...
		l.add(newResolution("Ã©cran","PbI-ecran",ResolutionCategory.find.findByCode("PbI"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 3));
		...
		l.add(newResolution("erreur paramÃ©trage run","PbI-parametrageRun",ResolutionCategory.find.findByCode("PbI"), DescriptionFactory.getInstitutes(Institute.CODE.CNS,Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 8));
		...
		l.add(newResolution("arret sÃ©quenceur","Info-arretSeq",ResolutionCategory.find.findByCode("RUN-Info"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 2));
		...
		l.add(newResolution("flowcell redÃ©posÃ©e","Info-FCredeposee",ResolutionCategory.find.findByCode("RUN-Info"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 5));

		l.add(newResolution("intensitÃ© B.M.S","QC-intBMS",ResolutionCategory.find.findByCode("QC"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.Run.name()), (short) 1));
		...
		//CNS + CNG
		l.add(newResolution("lane abandonnÃ©e","Run-abandonLane",ResolutionCategory.find.findByCode("Run"), DescriptionFactory.getInstitutes(Institute.CODE.CNS, Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 1));
		l.add(newResolution("rÃ©partition bases","Qlte-repartitionBases",ResolutionCategory.find.findByCode("Qlte"), DescriptionFactory.getInstitutes(Institute.CODE.CNS, Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 3));				
		...
		l.add(newResolution("erreur dÃ©pÃ´t banque","LIB-erreurDepot",ResolutionCategory.find.findByCode("LIB"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 2));
		...
		l.add(newResolution("% adaptateurs dÃ©tectÃ©s","Qlte-adapterPercent",ResolutionCategory.find.findByCode("Qlte"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 5));
		...
		l.add(newResolution("% duplicat Ã©levÃ©","Qlte-duplicatElevee",ResolutionCategory.find.findByCode("Qlte"), DescriptionFactory.getInstitutes(Institute.CODE.CNG), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 7));
				
		l.add(newResolution("conta indÃ©terminÃ©e","TAXO-contaIndeterm",ResolutionCategory.find.findByCode("TAXO"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 1));
		...
		l.add(newResolution("bactÃ©rie","TAXO-bacteria",ResolutionCategory.find.findByCode("TAXO"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 8)); 
		...
		l.add(newResolution("% rRNA Ã©levÃ©","RIBO-percEleve",ResolutionCategory.find.findByCode("RIBO"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 1));
		...
		l.add(newResolution("% lec mergÃ©es","MERG-PercLecMerg",ResolutionCategory.find.findByCode("MERG"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 1));
		l.add(newResolution("mÃ©diane lect mergÃ©es","MERG-MedLecMerg",ResolutionCategory.find.findByCode("MERG"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.ReadSet.name()), (short) 2));
		...
		//Experiment
		//CNS
		l.add(newResolution("% rRNA Ã©levÃ©","riboEleve",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		l.add(newResolution("dÃ©roulement correct",	"correct",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		l.add(newResolution("Ã©chec expÃ©rience",	"echec-experience",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("erreur matÃ©riel",	"erreur-sample",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("erreur rÃ©actif",	"erreur-reactif",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("erreur TAG utilisÃ©",	"erreur-tag",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("rÃ©actifs : lot Ã  problÃ¨me",	"pb-lotReactif",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("pb qtÃ© adaptateurs utilisÃ©",	"pb-qteAdaptateurs",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("perte de matÃ©riel aprÃ¨s purif",	"perte-materiel",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("tube tombÃ© en sortie d'exp",	"chute-supportContainer",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("qtÃ© en sortie d'exp insuf",	"qteFinaleInsuff",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		l.add(newResolution("tube bq transformÃ© en sol stock",	"transforme-solStock",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		l.add(newResolution("rÃ©sultat dosage trop faible",	"dosage-tropFble",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		l.add(newResolution("Qbit : non dÃ©tectÃ©",	"dosage-nonDetecte",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
		...
		l.add(newResolution("crÃ©Ã© par erreur",	"erreur-creation",ResolutionCategory.find.findByCode("default"), DescriptionFactory.getInstitutes(Institute.CODE.CNS), DescriptionFactory.getObjectTypes(ObjectType.CODE.Experiment.name()), (short) 1));
