...
public class ResolutionService {
	...
	/*	l.add(newResolution("R̩hybridation R1 / m̻me s̩quenceur","rehybridR1",ResolutionCategory.find.findByCode(ResolutionCategory.CODE.Experiment.name())));
		l.add(newResolution("R̩hybridation R1 / autre s̩quenceur","rehybridR1Ext",ResolutionCategory.find.findByCode(ResolutionCategory.CODE.Experiment.name())));
		l.add(newResolution("R̩hybridation Read Index","rehybridRIndex",ResolutionCategory.find.findByCode(ResolutionCategory.CODE.Experiment.name())));
		l.add(newResolution("R̩hybridation R2","rehybridR2",ResolutionCategory.find.findByCode(ResolutionCategory.CODE.Experiment.name())));		
		l.add(newResolution("D̩p̫t OK","depotOk",ResolutionCategory.find.findByCode(ResolutionCategory.CODE.Experiment.name())));
*/
		/*
