...
public class StateService {
	...
	public static void saveStates(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(newState("Soumission Validée utilisateur", "V-SUB", true, 2000, StateCategory.find.findByCode("IW"), getObjectTypes(ObjectType.CODE.SRASubmission.name(), ObjectType.CODE.SRAStudy.name(),ObjectType.CODE.SRASample.name(), ObjectType.CODE.SRAExperiment.name(), ObjectType.CODE.ReadSet.name()), true, null));		
		l.add(newState("Soumission en attente", "IW-SUB", true, 2001, StateCategory.find.findByCode("IW"), getObjectTypes(ObjectType.CODE.SRASubmission.name(), ObjectType.CODE.SRAStudy.name(),ObjectType.CODE.SRASample.name(), ObjectType.CODE.SRAExperiment.name(), ObjectType.CODE.ReadSet.name()), true, null));		
		l.add(newState("Soumission en cours", "IP-SUB", true, 2002, StateCategory.find.findByCode("IP"), getObjectTypes(ObjectType.CODE.SRASubmission.name(),  ObjectType.CODE.SRAStudy.name(),ObjectType.CODE.SRASample.name(), ObjectType.CODE.SRAExperiment.name(), ObjectType.CODE.ReadSet.name()), true, null));		
		l.add(newState("Soumission terminée", "F-SUB", true, 2003, StateCategory.find.findByCode("F"), getObjectTypes(ObjectType.CODE.SRASubmission.name(),  ObjectType.CODE.SRAStudy.name(),ObjectType.CODE.SRASample.name(), ObjectType.CODE.SRAExperiment.name(), ObjectType.CODE.ReadSet.name()), true, null));		
