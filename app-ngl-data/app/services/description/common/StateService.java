...
public class StateService {
	...
	public static void saveStates(Map<String, List<ValidationError>> errors) throws DAOException {
		...
		l.add(newState("Soumission Validée utilisateur", "V-SUB", true, 2000, StateCategory.find.findByCode("IW"), getObjectTypes(ObjectType.CODE.SRASubmission.name()), true, null));		
		...
		l.add(newState("Configuration utilisée dans une soumission", "U-SUB", true, 2005, StateCategory.find.findByCode("F"), getObjectTypes(ObjectType.CODE.SRAConfiguration.name()), true, null));		
		l.add(newState("Soumission pour release à New", "N-R", true, 2006, StateCategory.find.findByCode("N"), getObjectTypes(ObjectType.CODE.ReadSet.name(),ObjectType.CODE.SRASubmission.name()), true, null));
		l.add(newState("Soumission pour release study en attente", "IW-SUB-R", true, 2007, StateCategory.find.findByCode("IW"), getObjectTypes(ObjectType.CODE.SRASubmission.name(),ObjectType.CODE.ReadSet.name()), true, null));		
