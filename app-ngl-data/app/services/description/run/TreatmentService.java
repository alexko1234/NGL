...
public class TreatmentService {
	...
	public static List<PropertyDefinition> getReadQualityTreatmentPropertyDefinitions() throws DAOException{
		...
		propertyDefinitions.add(DescriptionFactory.newPropertiesDefinition("suspectedPrimers.primer","suspectedPrimers.primer",LevelService.getLevels(Level.CODE.ReadSet, Level.CODE.Read1, Level.CODE.Read2), String.class, false));
