...
public abstract class AbstractUpdateSampleNCBITaxon extends AbstractImportData{
	...
	public void updateSampleNCBI(ContextValidation contextError,
		...
		for(Sample sample: samples)
		{
			...
			SampleHelper.updateKeyInSampleAndPropertyContentContainer(sample, "ncbiScientificName", new PropertySingleValue(ncbiScientificName), contextError);
			SampleHelper.updateKeyInSampleAndPropertyContentContainer(sample, "ncbiLineage", new PropertySingleValue(ncbiLineage), contextError);
