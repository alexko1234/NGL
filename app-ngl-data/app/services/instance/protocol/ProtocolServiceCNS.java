...
public class ProtocolServiceCNS {	
	...
	public static void saveProtocols(ContextValidation ctx){		
		...
		if(ConfigFactory.load().getString("ngl.env").equals("PROD") ){
			...
			lp.add(newProtocol("bacteria-rRNA-depletion","Déplétion bactérienne","path2","1","production",InstanceFactory.setExperimentTypeCodes("dnase-treatment")));
			lp.add(newProtocol("plant-rRNA-depletion","Déplétion plante","path2","1","production",InstanceFactory.setExperimentTypeCodes("dnase-treatment")));
			
			lp.add(newProtocol("dosage_fluo","fluo-dosage","path2","1","production",InstanceFactory.setExperimentTypeCodes("fluo-quantification")));
			lp.add(newProtocol("PTR_CTL123_4","ptr-ctl-123-4","path2","1","production",InstanceFactory.setExperimentTypeCodes("gel-migration")));
