...
object ApplicationBuild extends Build {
   ...
   val sqVersion = "1.27.10.1-SNAPSHOT"  
   val biVersion = "1.33.6.1-SNAPSHOT"
   val projectsVersion = "1.2-SNAPSHOT"  
   val reagentsVersion = "1.2-SNAPSHOT" 
   val subVersion = "1.1-SNAPSHOT"  
   ...
   object Dependencies {
	...
	val nglreagentsDependencies = Seq(
   	...
   	val nglframeworkwebDependencies = Seq(
		...
		"fr.cea.ig.modules" %% "authentication" % "1.3-SNAPSHOT",
