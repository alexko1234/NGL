...
angular.module('home').controller('CreateCtrl',[ '$http', '$scope', '$routeParams' , 'mainService', 'lists', 'tabService','studiesCreateService','messages',
	...
	if(angular.isUndefined(mainService.getHomePage())){
		...
		tabService.addTabs({label:Messages('studies.menu.create'),href:jsRoutes.controllers.studies.tpl.Studies.home("create").url,remove:true});
	...
	$scope.save = function(){
		mainService.setForm($scope.createService.form);
			$http.post(jsRoutes.controllers.studies.api.Studies.save().url, mainService.getForm()).success(function(data) {
