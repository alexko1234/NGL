				...
				var baskets = {
					...
					*/
					fnModalControl:function(oConfig,text){
						...
						$('body').append('<div class="modal fade" id="'+oConfig.modalId+'"><div class="modal-header"><a class="close" data-dismiss="modal">&times;</a><h3>'+oConfig.titleModal+'</h3></div><div class="modal-body" id="modal-body"><p>'+text+'</p></div><div class="modal-footer"><a href="#" class="btn btn-default" data-dismiss="modal">'+oConfig.textCancelModal+'</a><a href="#" class="btn btn-primary" id="'+oConfig.idBtnModal+'">Add</a></div></div>');
					...
					*	@param experimentTypeCode String: the code of the type experiment
					*/
					setExperiment:function(experimentTypeCode){
						alert(experimentTypeCode);
