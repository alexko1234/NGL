...
angular.module('home', ['ngRoute','datatableServices','basketServices', 'commonsServices','ui.bootstrap','atomicTransfereServices','dragndropServices','ngl-sq.experimentsServices'], function($routeProvider, $locationProvider) {
