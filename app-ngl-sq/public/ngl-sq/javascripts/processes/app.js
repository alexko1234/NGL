...
angular.module('home', ['commonsServices','ngRoute','ultimateDataTableServices','basketServices','ui.bootstrap','ngl-sq.processesServices','ngl-sq.samplesServices'], function($routeProvider, $locationProvider) {
