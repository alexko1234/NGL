...
public class AnalysesTest extends AbstractBIServerTest{
	...
	public void test1save()
	{
		...
		WSHelper.post(ws, "/api/analyses", jsonAnalysis, 200);
	...
	public void test2list()
	{
		...
		WSResponse response = WSHelper.get(ws, "/api/analyses", 200);
	...
	public void test3get()
	{
		...
		WSResponse response = WSHelper.get(ws, "/api/analyses/"+analysis.code, 200);
		assertThat(response.asJson()).isNotNull();
	}
	...
	public void test4head()
	{
		...
		WSResponse response = WSHelper.head(ws, "/api/analyses/"+analysis.code, 200);
	...
	public void test5update()
	{
		...
		analysis.path="test";
		WSHelper.putObject(ws, "/api/analyses/"+analysis.code,analysis, 200);
		analysis = MongoDBDAO.findByCode(InstanceConstants.ANALYSIS_COLL_NAME, Analysis.class, analysis.code);
	...
	public void test6valuation()
	{
		...
		WSHelper.putObject(ws, "/api/analyses/"+analysis.code+"/valuation",valuation, 200);
		analysis = MongoDBDAO.findByCode(InstanceConstants.ANALYSIS_COLL_NAME, Analysis.class, analysis.code);
	...
	public void test7properties()
	{
		...
		WSHelper.putObject(ws, "/api/analyses/"+analysis.code+"/properties",analysis, 200);
		analysis = MongoDBDAO.findByCode(InstanceConstants.ANALYSIS_COLL_NAME, Analysis.class, analysis.code);
	...
	public void test8delete()
	{
		...
		WSHelper.delete(ws,"/api/analyses/"+analysis.code,200);
