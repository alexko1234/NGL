...
@Controller
public class Analyzes extends DocumentController<Analysis>{

	final static Form<AnalyzesSearchForm> searchForm = form(AnalyzesSearchForm.class);
	final static Form<Valuation> valuationForm = form(Valuation.class);
	final static Form<State> stateForm = form(State.class);
	final static Form<AnalyzesBatchElement> batchElementForm = form(AnalyzesBatchElement.class);
	...
	public Result list() {
		Form<AnalyzesSearchForm> filledForm = filledFormQueryString(searchForm, AnalyzesSearchForm.class);
		AnalyzesSearchForm form = filledForm.get();
	...
	public Result stateBatch(){
		List<Form<AnalyzesBatchElement>> filledForms =  getFilledFormList(batchElementForm, AnalyzesBatchElement.class);
		List<DatatableBatchResponseElement> response = new ArrayList<DatatableBatchResponseElement>(filledForms.size());
		
		for(Form<AnalyzesBatchElement> filledForm: filledForms){
			AnalyzesBatchElement element = filledForm.get();
